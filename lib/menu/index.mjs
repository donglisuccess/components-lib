import { defineComponent as u, resolveComponent as n, openBlock as t, createBlock as c, mergeProps as C, withCtx as h, createElementBlock as l, Fragment as d, renderList as M, createCommentVNode as i, resolveDynamicComponent as g, unref as f, createElementVNode as e, toDisplayString as x, useAttrs as H, createVNode as s, isVNode as V, markRaw as y } from "vue";
const z = (a) => a.replace(/([A-Z])/g, "-$1").toLowerCase(), B = /* @__PURE__ */ u({
  __name: "index",
  props: {
    data: {
      type: Array,
  ...
  setup(a) {
    return (r, _) => {
      const v = n("el-menu-item"), o = n("el-sub-menu"), w = n("el-menu");
      return t(), c(w, C({
        router: a.router,
        ...
        default: h(() => [
          (t(!0), l(
            ...
            M(a.data, (p) => (t(), l(
              ...
              [
                i(" 一级菜单 "),
                !p.children || !p.children.length ? (t(), c(v, {
                  key: 0,
                  index: p.index
                }, {
                  default: h(() => [
                    p.icon ? (t(), c(g(`el-icon${f(z)(p.icon)}`), { key: 0 })) : i("v-if", !0),
                    e(
                      "span",
                      null,
                      x(p.name),
                ...
                i(" 二级菜单 "),
                p.children && p.children.length ? (t(), c(o, {
                  key: 1,
                  index: p.index
                }, {
                  title: h(() => [
                    (t(), c(g(`el-icon${f(z)(p.icon)}`))),
                    e(
                      "span",
                      null,
                      x(p.name),
                  ...
                  default: h(() => [
                    (t(!0), l(
                      d,
                      null,
                      M(p.children, (m) => (t(), c(v, {
                        key: m.index,
                        index: m.index
                      }, {
                        default: h(() => [
                          (t(), c(g(`el-icon${f(z)(m.icon)}`))),
                          e(
                            "span",
                            null,
                            x(m.name),
        ...
        _: 1
        /* STABLE */
      }, 16, ["router", "default-active", "collapse"]);
    };
  }
}), L = (a, r) => {
  ...
  for (const [v, o] of r)
    _[v] = o;
  return _;
}, A = /* @__PURE__ */ L(B, [["__scopeId", "data-v-2e6e0f67"]]);
...
const H_ = /* @__PURE__ */ u({
  ...
  setup(a) {
    ...
    let _ = (v) => v.map((o) => {
      o.i = y(M_[o.icon]);
      let w = {
        title: () => s(d, null, [s(o.i, null, null), s("span", null, [o.name])])
      };
      return o.children && o.children.length ? s(n("el-sub-menu"), {
        index: o.index
      }, {
        default: () => [_(o.children)],
        ...w
      }) : s(n("el-menu-item"), {
        index: o.index
      }, {
        default: () => [s(o.i, null, null), s("span", null, [o.name])]
      });
    });
    return () => {
      let v;
      return s(n("el-menu"), C({
        style: "width: 200px;",
        "default-active": a.defaultActive,
        router: a.router
      }, r), C_(v = _(a.data)) ? v : {
  ...
  install(a) {
    a.component("my-menu", A), a.component("my-infinite-menu", H_);
  }
};
export {
  y_ as default

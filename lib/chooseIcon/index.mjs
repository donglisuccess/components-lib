import { defineComponent as l, openBlock as _, createElementBlock as o, createElementVNode as r, unref as v, getCurrentScope as y0, onScopeDispose as M0, ref as y, readonly as H0, getCurrentInstance as T, onMounted as U2, nextTick as V0, watch as A, warn as B0, inject as O, computed as g, isRef as G2, provide as b0, renderSlot as G, mergeProps as L0, normalizeClass as b, createVNode as $, Transition as W2, withCtx as P, withDirectives as K2, normalizeStyle as Z2, toDisplayString as u2, vShow as Q2, shallowReactive as A0, createBlock as F, createCommentVNode as Q, resolveDynamicComponent as J2, Fragment as Y2, withModifiers as S0, isVNode as X2, render as y2, resolveComponent as M2, renderList as k0 } from "vue";
...
const _2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ZoomIn: gl,
  ZoomOut: fl
}, Symbol.toStringTag, { value: "Module" })), H2 = (e) => e.replace(/([A-Z])/g, "-$1").toLowerCase();
var V2;
...
const a0 = I ? window : void 0;
function Hl(...e) {
  let t, a, n, u;
  if (xl(e[0]) || Array.isArray(e[0]) ? ([a, n, u] = e, t = a0) : [t, a, n, u] = e, !t)
    return Cl;
  Array.isArray(a) || (a = [a]), Array.isArray(n) || (n = [n]);
  const p = [], s = () => {
    p.forEach((h) => h()), p.length = 0;
  }, c = (h, d, M, B) => (h.addEventListener(d, M, B), () => h.removeEventListener(d, M, B)), m = A(() => [t0(t), i2(u)], ([h, d]) => {
    s(), h && p.push(...a.flatMap((M) => n.map((B) => c(h, M, B, d))));
...
function Al(e, t, a = {}) {
  const n = a, { window: u = a0 } = n, p = Ll(n, ["window"]);
  let s;
  const c = Vl(() => u && "ResizeObserver" in u), m = () => {
    s && (s.disconnect(), s = void 0);
  }, f = A(() => t0(e), (d) => {
    m(), c.value && u && d && (s = new ResizeObserver(t), s.observe(d, p));
...
process.env.NODE_ENV !== "production" && Object.freeze([]);
const Tl = Object.prototype.hasOwnProperty, F2 = (e, t) => Tl.call(e, t), Y = (e) => typeof e == "function", R = (e) => typeof e == "string", r0 = (e) => e !== null && typeof e == "object";
var ql = typeof global == "object" && global && global.Object === Object && global, Dl = typeof self == "object" && self && self.Object === Object && self, d2 = ql || Dl || Function("return this")(), q = d2.Symbol, _0 = Object.prototype, Il = _0.hasOwnProperty, Nl = _0.toString, E = q ? q.toStringTag : void 0;
function El(e) {
  var t = Il.call(e, E), a = e[E];
  try {
    e[E] = void 0;
    var n = !0;
  } catch {
...
function l0(e) {
  return e == null ? e === void 0 ? Gl : Ul : O2 && O2 in Object(e) ? El(e) : jl(e);
}
function Wl(e) {
...
function m2(e) {
  return typeof e == "symbol" || Wl(e) && l0(e) == Kl;
}
function Zl(e, t) {
...
var l2 = d2["__core-js_shared__"], q2 = function() {
...
function B5(e) {
  var t = this.__data__;
  return j ? t[e] !== void 0 : V5.call(t, e);
}
var b5 = "__lodash_hash_undefined__";
function L5(e, t) {
  var a = this.__data__;
  return this.size += this.has(e) ? 0 : 1, a[e] = j && t === void 0 ? b5 : t, this;
}
function S(e) {
...
N.prototype.clear = A5;
N.prototype.delete = F5;
N.prototype.get = O5;
N.prototype.has = P5;
N.prototype.set = T5;
var q5 = u0(d2, "Map");
...
const r9 = (e) => e === void 0, U = (e) => typeof e == "number", _9 = (e) => typeof Element > "u" ? !1 : e instanceof Element, l9 = (e) => R(e) ? !Number.isNaN(Number(e)) : !1, D2 = (e) => Object.keys(e);
...
function o2(e, t = "px") {
  ...
  if (R(e))
    return e;
  W(n9, "binding value must be a string or number");
}
const s0 = "__epPropKey", H = (e) => e, u9 = (e) => r0(e) && !!e[s0], p0 = (e, t) => {
  if (!r0(e) || u9(e))
    return e;
  const { values: a, required: n, default: u, type: p, validator: s } = e, m = {
    type: p,
    required: !!n,
    validator: a || s ? (f) => {
      let h = !1, d = [];
      if (a && (d = Array.from(a), F2(e, "default") && d.push(u), h || (h = d.includes(f))), s && (h || (h = s(f))), !h && d.length > 0) {
        const M = [...new Set(d)].map((B) => JSON.stringify(B)).join(", ");
        B0(`Invalid prop: validation failed${t ? ` for prop "${t}"` : ""}. Expected one of [${M}], got value ${JSON.stringify(f)}.`);
      }
      return h;
    } : void 0,
    [s0]: !0
  };
  return F2(e, "default") && (m.default = u), m;
}, K = (e) => a9(Object.entries(e).map(([t, a]) => [
  t,
  p0(a, t)
])), s9 = H([
  String,
...
}, i9 = ["", "default", "small", "large"], h9 = (e) => e, N2 = ({ from: e, replacement: t, scope: a, version: n, ref: u, type: p = "API" }, s) => {
  A(() => v(s), (c) => {
    c && W(a, `[${p}] ${e} is about to be deprecated in version ${n}, please use ${t} instead.
...
const m9 = (e) => (t, a) => g9(t, a, v(e)), g9 = (e, t, a) => t9(a, e, e).replace(/\{(\w+)\}/g, (n, u) => {
...
}, v0 = Symbol("localeContextKey"), f9 = (e) => {
  const t = e || O(v0, y());
  return w9(g(() => t.value || d9));
}, J = "el", x9 = "is-", L = (e, t, a, n, u) => {
  let p = `${e}-${t}`;
  return a && (p += `-${a}`), n && (p += `__${n}`), u && (p += `--${u}`), p;
}, i0 = Symbol("namespaceContextKey"), C9 = (e) => {
  const t = e || (T() ? O(i0, y(J)) : y(J));
  return g(() => v(t) || J);
}, f2 = (e, t) => {
  const a = C9(t);
  return {
  ...
  current: 0
}, $2 = y(0), h0 = 2e3, R2 = Symbol("elZIndexContextKey"), d0 = Symbol("zIndexContextKey"), z9 = (e) => {
  const t = T() ? O(R2, E2) : E2, a = e || (T() ? O(d0, void 0) : void 0), n = g(() => {
    const s = v(a);
    return U(s) ? s : h0;
  }), u = g(() => n.value + $2.value), p = () => (t.current++, $2.value = t.current, u.value);
  return !I && !O(R2) && W("ZIndexInjection", `Looks like you are using server rendering, you must provide a z-index provider to ensure the hydration process to be succeed
...
function V9(e, t) {
  const a = g0(), n = f2(e, g(() => {
    ...
    var c;
    return ((c = a.value) == null ? void 0 : c.zIndex) || h0;
  })), s = g(() => {
    var c;
...
const w0 = (e, t, a = !1) => {
  var n;
  const u = !!T(), p = u ? g0() : void 0, s = (n = void 0) != null ? n : u ? b0 : void 0;
  if (!s) {
  ...
  const c = g(() => {
    const m = v(e);
    return p != null && p.value ? B9(p.value, m) : m;
  });
  return s(m0, c), s(v0, g(() => c.value.locale)), s(i0, g(() => c.value.namespace)), s(d0, g(() => c.value.zIndex)), s(M9, {
    size: g(() => c.value.size || "")
...
l({
  ...
  setup(e, { slots: t }) {
    ...
    const a = w0(e);
    return () => G(t, "default", { config: a == null ? void 0 : a.value });
  }
});
var x2 = (e, t) => {
...
const j2 = c0(k9), F9 = K({
  ...
  props: F9,
  setup(e, { expose: t }) {
    const a = e, n = f2("badge"), u = g(() => a.isDot ? "" : U(a.value) && U(a.max) ? a.max < a.value ? `${a.max}+` : a.value === 0 && !a.showZero ? "" : `${a.value}` : `${a.value}`), p = g(() => {
      var s, c, m, f, h, d;
      return [
        {
          backgroundColor: a.color,
          marginRight: o2(-((c = (s = a.offset) == null ? void 0 : s[0]) != null ? c : 0)),
          marginTop: o2((f = (m = a.offset) == null ? void 0 : m[1]) != null ? f : 0)
        },
        (h = a.dotStyle) != null ? h : {},
...
const D9 = c0(q9), f0 = ["success", "info", "warning", "error"], C = h9({
  customClass: "",
  center: !1,
  ...
  emits: N9,
  setup(e, { expose: t }) {
    const a = e, { Close: n } = p9, { ns: u, zIndex: p } = V9("message"), { currentZIndex: s, nextZIndex: c } = p, m = y(), f = y(!1), h = y(0);
    let d;
    const M = g(() => a.type ? a.type === "error" ? "danger" : a.type : "info"), B = g(() => {
      const x = a.type;
      return { [u.bm("icon", x)]: x && I2[x] };
    }), a2 = g(() => a.icon || I2[a.type] || ""), i = g(() => $9(a.id)), w = g(() => R9(a.id, a.offset) + i.value), z = g(() => h.value + w.value), C0 = g(() => ({
      top: `${w.value}px`,
      zIndex: s.value
    }));
    function r2() {
      a.duration !== 0 && ({ stop: d } = Ml(() => {
        Z();
      }, a.duration));
    }
    function C2() {
    ...
    return U2(() => {
      ...
      onAfterLeave: z2[0] || (z2[0] = (no) => x.$emit("destroy")),
      persisted: ""
    }, {
      default: P(() => [
        K2(r("div", {
          ...
          G(x.$slots, "default", {}, () => [
            x.dangerouslyUseHTMLString ? (_(), o(Y2, { key: 1 }, [
...
let Z9 = 1;
const x0 = (e) => {
  const t = !e || R(e) || X2(e) || Y(e) ? { message: e } : e, a = {
    ...C,
    ...t
  };
  if (!a.appendTo)
    a.appendTo = document.body;
  else if (R(a.appendTo)) {
    let n = document.querySelector(a.appendTo);
    _9(n) || (W("ElMessage", "the appendTo option is not an HTMLElement. Falling back to document.body."), n = document.body), a.appendTo = n;
  }
  return a;
}, Q9 = (e) => {
  const t = V.indexOf(e);
  ...
  }, c = $(K9, s, Y(s.message) || X2(s.message) ? {
...
const X9 = c9(D, "$message"), eo = (e) => {
...
}, to = { class: "container" }, ao = ["onClick"], ro = { class: "text" }, _o = /* @__PURE__ */ l({
  __name: "index",
  props: {
    title: {},
  ...
  setup(e, { emit: t }) {
    ...
    const p = () => {
      ...
      eo(`<el-icon${H2(c)} />`), u.value = !1;
    };
    return A(() => a.visible, (c) => {
      u.value = c;
    }), A(() => u.value, (c) => {
      n("update:visible", c);
    }), (c, m) => {
      const f = M2("el-button"), h = M2("el-dialog");
      return _(), o("div", null, [
        $(f, {
          type: "primary",
          onClick: p
        ...
        $(h, {
          title: c.title,
          modelValue: v(u),
          "onUpdate:modelValue": m[0] || (m[0] = (d) => G2(u) ? u.value = d : u = d),
          class: "m-choose-dialog-body-height"
        }, {
          default: P(() => [
            r("div", to, [
              (_(!0), o(
                Y2,
                null,
                k0(Object.keys(_2), (d, M) => (_(), o("div", {
                  class: "item",
                  key: M,
                  onClick: (B) => s(d)
                }, [
                  (_(), F(J2(`el-icon${v(H2)(_2[d].name)}`))),
                  r(
                    "span",
                    ro,
                    u2(d),
  ...
  for (const [n, u] of t)
    a[n] = u;
  return a;
}, oo = /* @__PURE__ */ lo(_o, [["__scopeId", "data-v-7b2bcf16"]]), so = {
  install(e) {
    e.component("my-choose-icon", oo);
  }
};
export {
  so as default
